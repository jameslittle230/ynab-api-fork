...
pub struct TransactionDetail {
    ...
    pub cleared: crate::models::TransactionClearedStatus,
    /// Whether or not the transaction is approved
    #[serde(rename = "approved")]
    pub approved: bool,
    #[serde(rename = "flag_color", skip_serializing_if = "Option::is_none")]
    pub flag_color: Option<crate::models::TransactionFlagColor>,
    /// The customized name of a transaction flag
    #[serde(rename = "flag_name", skip_serializing_if = "Option::is_none")]
...
impl TransactionDetail {
    pub fn new(id: String, date: String, amount: i64, cleared: crate::models::TransactionClearedStatus, approved: bool, account_id: String, deleted: bool, account_name: String, subtransactions: Vec<crate::models::SubTransaction>) -> TransactionDetail {
        TransactionDetail {
            id,
            date,
            amount,
