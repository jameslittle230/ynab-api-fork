...
impl TransactionSummary {
    pub fn new(id: String, date: String, amount: i64, cleared: crate::models::TransactionClearedStatus, approved: bool, account_id: String, deleted: bool) -> TransactionSummary {
        TransactionSummary {
            id,
            date,
            amount,
