...
pub mod new_transaction_all_of;
pub use self::new_transaction_all_of::NewTransactionAllOf;
...
pub mod save_transaction_with_id_or_import_id_all_of;
pub use self::save_transaction_with_id_or_import_id_all_of::SaveTransactionWithIdOrImportIdAllOf;
