...
impl HybridTransaction {
    pub fn new(id: String, date: String, amount: i64, cleared: crate::models::TransactionClearedStatus, approved: bool, account_id: String, deleted: bool, _type: Type, account_name: String) -> HybridTransaction {
        HybridTransaction {
            id,
            date,
            amount,
